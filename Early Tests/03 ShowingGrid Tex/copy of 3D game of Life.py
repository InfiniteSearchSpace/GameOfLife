...
class game:
	def __init__(self):
		...
		self.current_grid = np.where((np.random.randint(6, size=(self.grid_w, self.grid_h)))==1, 1, 0)
		self.next_grid = np.where((np.random.randint(6, size=(self.grid_w, self.grid_h)))==1, 1, 0)
	...
	def initTexture(self):
		...
		data = np.where((np.random.randint(6, size=(self.grid_w, self.grid_h)))==1, 255, 0)
		w,h = data.shape
